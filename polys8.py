...
#         filepath = 'C:/Users/Reed Howald/Desktop/pythonProject3/filey/'
        ...
        choice = fchoice.read()
        print('242 ', tfile, ir, choice, filepath)
        fsize = runf[1][5]
        print('244 fsize is  ', fsize, runf[1][1])
        txf = 'You found this: '
        txg = 'special text '
        rowe = runf[3][9]
        if int(fsize) > 0:
...
def ccount(runf, menuf, ir, pic, choice, fchoice, filepath, setf5, f, detf5, ctexcel, filepathb, ira, irb, fpk):
    print('1900 !!IN ccount WITH choice = ', choice)
    ccx = runf[5][8]
    print('1902 ccx  IS ', ccx, choice)
    if ccx != 12:
        return()
    fr = open(filepath +'ccount.txt', 'r')
    cho = fr.readline()
