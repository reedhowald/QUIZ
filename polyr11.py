...
#         font.setPointSize(int(str(runf[0][5])))
        ...
        print('278 runf[6][11] is ', runf[6][11], ccm, ccw, ccy)
        ry = str(runf[ir - 0][6])
        gy = str(runf[ir - 0][7])
        by = str(runf[ir - 0][8])
#         ry = '255'
...
# PROGRAM FOR CORRECT CHOICES
    print('1956 right choice is ', choice, ccx, cho )
...
#     s8 = fr.readline()
#     fr.close()
    print('1986 ccount.txt has been written with czz = ', czz)
...
print('1897 starting the program poly7.py')
