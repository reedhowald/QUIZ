...
# filepath is read from controlstart.txt twice.  Here and at line 1694
        ...
        filepathi = 'C:/Users/Reed Howald/desktop/5poly/'
...
#         n 'C:/Users/Reed Howald/desktop/filew/'
        ...
        f.close()
        print('line 92 filepath is ',  filepath, pic)
...
#         self.set_partial_credit('pa,pb,pc')
        print('219 filename is ', filename)
...
#         filepath = 'C:/Users/reedh/Desktop/pythonProject3/filez/'
        ...
        print('233 ir = ', ir)
        tfile = str(runf[ir][2])
        print("235 tfile is ", tfile)
#         filepath = 'C:/Users/Reed Howald/Desktop/pythonProject3/filey/'
        fchoice = open(filepath + "choice.txt", 'r')
        choice = fchoice.read()
        print('239  ', tfile, ir, choice, filepath)
        fsize = runf[1][5]
        print('241 fsize is  ', fsize, runf[1][1])
        txf = 'You found this: '
        txg = 'special text '
        rowe = runf[3][9]
        if int(fsize) > 0:
            ...
            z = len(txg) - 1
            txf = txg[:z]
            print('251 txf is ', txf,'  ', setline)
#         headerstring = txf + str(choice) + ' row ' + str(setline)
        headerstring = txf + choice + '  row is ' + str(ir)
        print('254 header is:  ', headerstring, txf, choice)
#         headerstring = 'You typed   ' + '  ' + str(choice)
#         setting edit widget size
        if int(setf5[5][11]) == 193:
            fsize = int(setf5[0][5])
            print('259 changing to ', fsize)
        else:
            fsize = int(runf[0][5])
        # fsize = 0
        font = QFont()
        print('262 edit font size set to ', fsize, runf[0][5], setf5[0][5], setf5[5][11])
...
#         font.setPointSize(int(str(runf[0][5])))
        ...
        if runf[6][12] == 25:
            ...
            headerstring = headerstring + choice + '\nwrong' + sp + sp
            headerstring = headerstring + ccn + sp + ccm
            headerstring = headerstring + 'correct' + sp + ccw + sp + ccy
            print('276 in if ccw is ', ccw, headerstring)
        print('277 runf[6][12] is ', runf[6][12], ccy, runf[6][11] )
        print('278 5 8 ', runf[5][8])
        ry = str(runf[ir - 0][6])
        gy = str(runf[ir - 0][7])
        by = str(runf[ir - 0][8])
#         ry = '255'
...
#         self.header.setStyleSheet("QLineEdit {background-color: rgb(" + rgba + ");}")
        print("288 top widget color  ", ry, gy, by)
        print('289 runf[0][2] is ', runf[0][2], setf5[0][2])
        fsize = 53
        fsize = runf[1][5]
...
# the instructions for the edit widget use lines 200 through 259 at this time
        with open(filepath + "ivy.txt", 'r')as f2:
            ...
            ivz = f2.readline()
#             setline = f2.readline()
            print('320 ', ivy, ihx, ir)
        tfile = runf[ir][2]
        print('322 tfile = ', tfile, ir )
...
#         ix = runf[ir][4]
        ix = int(setline)
        print('335 ivx = ', ivy, ir, setline, ix)
        sp = ' '
        sr = '\n'
        sp3 = '   '
        print('339  ', setline, ix)
        headerstring = txf
...
#         with open(filepath + ufile, 'r') as f:
 ...
 #             tx4 = f.readline()
            ...
            txa = f.readline()
            txb = f.readline()
        print('377 filepath ', filepath)
        ihx = int(ihx)
        fcolor = open(filepath + "colori.txt", 'r')
        colori = fcolor.read()
#         colori = int(colori)
        print('382 colori is ', str(colori), filepath)
#         colori = int(colori)
...
#         ihx3 = setcolumn
        ...
        print('401 ihx4 is   ', ihx4, ihx3, colori)
#         if ihx4 > 3:
#             ihx4 = ihx4 - 3
        print('404 tx8 and ihx4 are ', str(tx8), ihx4, str(tx9))
...
#     filepath = 'C:/Users/Reed Howald/desktop/file1/'
    ...
    print("973 READING  ", currentrun, runf)
...
###   [[1], [mf], [screenshot(9).png], [14], [600], [900], [550], [60], [10], [2], [0.], [0], [0.], [1.], [1.],
 ###  [0.], [1.], [Foot quiz]],
##   [0.], [1.], [Foot quiz]],
    print('1040 setf5 ', setf5[3][6])
#     print(runf[2][16])
    filename2 = filepath + currentrun
    filename3 = filepathb + str(get5f)
    print("1045 filename2 is ", filename2 , 'ir is ', ir, getf5)
    if currentrun != 'rs.rna':
        if int(setf5[3][6]) > 60:
            readcsvfile(filename2, setf5)
        print("1048 read ", filename2, ' ir is ', ir, setf5[3][11])
    print('1049 runf[2][3] = ', ir, runf[2][3], setf5[2][3] )
#     if int(runf[2][4]) == 10:
    if editrun != 'rs.rna':
...
#         readcsvfile(filename3, setf5)
        if int(runf[4][11])  == 12:
            readcsvfile(filename3, setf5)
    print('line 1056 ir = ', ir, runf[4][11])
    print('1057 setf5[4][11] = ', setf5[4][11], runf[4][11], filename3)
#     readcsvfile(filename, getf5)
#     print(runf[3][7])
    print('1060 runf[4][11] is ', runf[4][11])
    print('1061 setf5[2][6] = ', setf5[2][6])
    print('1062 iz  ir =    ', ir)
#     open
#     filename = 'runfoot.xls'
#     writeexcel(setf5, filename, ir, f, filepath, editrun)
    print('NOW 1066 runf AND setf5 are ', runf[0][2], setf5[0][2])
...
#         print("display running with choice of  ", choice)
            ...
            if setf5[5][9] == 9:
                ...
                print('1176 runf[3][10] is  ', runf[3][10], runf[3][11])
...
# Subroutine to display a picture on the screen
    print('1570 displaying ir = ', ir, ' and ', pic , '  ', filepathb)
# pic = 'C:/Users/Reed Howald/desktop/file1/footmenu1.png'
#     app = QA
#     pplication()
    w = QuizWindow()
    ...
    if z > 1:
        choice = choice[:z]
    print("1582 returned with ", choice, ir, z)
    print('in display() line 1583 with ', choice)
    fchoice.close()
#     close(app)
...
def checkchoice(runf, menuf, ir, pic, choice, fchoice, filepath, setf5, f, detf5, ctexcel, filepathb, ira, irb, fpk):
    print('checkchoice line 1589 with ', choice, ir )
...
# This is a shortcut for anyone who finds nx too cumbersome to type
        ...
        print('1582 choice of ', choice, ira, irb,ir)
#         switchba(runf, menuf, ir, pic, choice, fchoice, filepath, setf5, f, runbi, ctexcel, filepathb, ira, irb)
        iraa =ira + 1
        irbb = irb+1

        print('1585 picture choices ', runf[iraa][3], setf5[iraa][3], runf[irbb][3], setf5[irbb][3] )
        iq = int(runf[4][8])
        if iq == 2:
            fic = 'rchcd.rng'
...
#         print('967 menuf[4][2] = ', menuf[4][2])
        if choice == str(menuf[iv][2]):
            print('1665 menuf[iv][2] = ', menuf[iv][2])
...
#                 setf5[0][iz] = value
                runf[2][11]  = value
                print('1674 the value is ', value, choice, iz, ir, iv)
            if iz > 8:
                iw = int(menuf[iv][5])
                iz = iz - 1
                print('1679 the value is ', value, choice, iz, ir, iv, iw)
...
#             print('line 917 ', setf5[1][3])
            print('1690 iz  = ', iz, ir, iv, iw, value)
            runf[2][11] = value
            if iz == 6:
                change(runf, menuf, ir, pic, choice, fchoice, filepath, setf5, f, runbi, ctexcel, filepathb, ira, irb, fpk)
#             setf5[1][iz] = value
#             runf[1][int(iz)] = setf5[1][iz]
            if iz < 8:
                print('1697 ', str(value), iz, runf[0][6])
#             runf[0][iz] = value
            elif iz > 7:
                runf[0][iz] = fvalue
            print('1701 New value at ', runf[0][iz], iz, ir, iv, iw, value, ira)
#             ir = ir+ 1
#             print('line 1009 selecting new ', currentrun)qt
#             ir = 0
            print("1705 iz = ", iz, ir, iv, iw, value)
...
def change(runf, menuf, ir, pic, choice, fchoice, filepath, setf5, f, runbi, ctexcel, filepathb, ira, irb, fpk):
    print('!!  1762 1762  in subroutine change() ', ir, ira, irb)
    print('1763 filepaths are ', fpk, filepath, filepathb, ira)
#     if ira == -1:
#         irq = 0#       ira = ira + 4
#         fpq = filepath
#     irq = irq +1
    ...
    colori = fcolor.read()
    print('1772 fcolor is ', fcolor, ' filepathb, fpk,')

    print('1774 colori = ', colori, filepath, filepathb)
    colori = int(colori)
    print('1776 colori = ', colori, ira, irb)
#     if colori == 1:
#         fpk = filepath
    imax = 11
    iskip = 1
...
#             f.write(str(colori))
        print('1785 colori is ', colori, iskip, fpk)
        #         imax = setf5[1][3]
        #         print('line 832 with imax = ', imax)
        filename = filepath + runf[0][2]
        writecsvfile(filename, runf, imax)
        print('1790 NOW PRINTING ',filename, colori, ir)
        iskip = 2
    print('1792 filepaths are ', filepath, filepathb, fpk)
...
#     close(f)
    ...
    ih = ih+colori
    iv2 = int(runf[iv - 1][9])
    print('1805 iv2 is  ', iv2, ih, iv, iskip, ivhp, value)
    if iskip == 1:
        runf[iv2][ih] = value
        setf5[iv2][ih] = value
        ihx3 = ih
        ...
        print('1812 here with ', ih, iv, runf[iv2][ih])
    print("1813 runf[0][9] is now ", runf[iv2][ih], iv2, ih)
    print('1814 ', runf[iv2][ih] , iv2, ih, value)
    print('1815 colori is ', colori, iv2, ih, ira)
    colori = colori + 1
    iskip = 1
    with open(fpk + 'colori.txt', 'w')as f:
        f.write(str(colori))
...
#         fcolor.write(str(colori))
        #         imax = setf5[1][3]
        print("1842 fpk is ", fpk, filepathb, colori)
        #         print('line 832 with imax = ', imax)
        filename = filepathb + runf[0][2]
        writecsvfile(filename, runf, imax)
        print('1846 NOW PRINTING ', filename, colori, ir)
        iskip = 2
    ...
    #
#     switchba(runf, menuf, ir, pic, choice, fchoice, filepath, setf5, f, runbi, ctexcel, filepathb, ira, irb)
    print("1856 ira is ", ira, irb, choice)
    dorunf(runf, menuf, ir, pic, choice, fchoice, filepath, setf5, f, runbi, ctexcel, filepathb, ira, irb, fpk)
#     quit()
#     dorunf(runf, menuf, ir, pic, choice, fchoice, filepath, setf5, f, runbi, ctexcel)
...
def rbrestart(currentrun, currentmenu, filepath, ir, begin):
    print('1866 in sbrestart with begin = ', begin)
...
def ccount(runf, menuf, ir, pic, choice, fchoice, filepath, setf5, f, detf5, ctexcel, filepathb, ira, irb, fpk):
    print('1896 *** !!IN ccount WITH choice = ', choice)
    ccx = runf[5][8]
    print('1899 ccx  IS ', ccx, choice)
    if ccx != 12:
        return()
    fr = open(filepath +'ccount.txt', 'r')
    cho = fr.readline()
    ...
    print('1911 ccn is ', choice, ccn, ccm)
    print('1912 ccw is  ', ccw, ccy)
#     choice = string(choice)
    ...
    if runf[5][9] != 15:
        ...
        ccm = ccm[0:-1]
        ccm = ccm + ' ' + chold
        print('1926 ccn is now ', ccn , ccm)
        print('1927 cchold is ', chold, choice, ccy)
        if czy == 2:
            return()
#         f2.write(str(ccw) + '\n')
...
# PROGRAM FOR CORRECT SHOICES
    print('1947 right choice is ', choice, ccx, irb )
    fr= open(filepath + 'cchoice.txt','r')
    cho = fr.readline()
    ccc = fr.readline()
    ccn = fr.readline()
    ccm = fr.readline()
    ...
    print('1958 fr.txt has been read with ccn = ', ccn, ccm)
...
print('1966 starting the program polyr8.py')
print('1967 This is a polynomiasl quiz ')
...
filepath=f.readline()
currentrun=f.readline()
print('1975 filepath is ', filepath + currentrun)
print('1976 currentrun is ', currentrun)
ir = 0
currentmenu=f.readline()
filepathb=f.readline()
runbi=f.readline()
...
print('1998 filepathb is ', filepathb, irb)
print('1999 sta0rting with ', currentrun, get5f)
print(currentmenu)
