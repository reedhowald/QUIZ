...
def ccount(runf, menuf, ir, pic, choice, fchoice, filepath, setf5, f, detf5, ctexcel, filepathb, ira, irb, fpk):
    print('1980 !!IN ccount WITH choice = ', choice)
    ccx = runf[5][8]
    print('1982 ccx  IS ', ccx, choice)
    if ccx != 12:
        return()
    fr = open(filepath +'ccount.txt', 'r')
    cho = fr.readline()
    ...
    print('1916 ccn is ', choice, ccn, ccm)
...
#     s8 = fr.readline()
#     fr.close()
    print('1988 ccount.txt has been written with czz = ', czz)
...
print('2018 starting the program polyr8.py')
print('2019 This is a polynomial quiz ')
...
filepath=f.readline()
currentrun=f.readline()
print('2027 filepath is ', filepath + currentrun)
print('2028 currentrun is ', currentrun)
ir = 0
currentmenu=f.readline()
filepathb=f.readline()
runbi=f.readline()
...
print('2050 filepathb is ', filepathb, irb)
print('2051 starting with ', currentrun, get5f)
print(currentmenu)
